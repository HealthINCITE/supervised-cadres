...
class DGenerator:
    def generate_cadres(samples, features, informative, cadres, seed, redundant, classep, flip):
        """
        samples = sample size
        ...
        X, y= make_classification(n_samples=samples, n_features=features, n_informative=informative,  n_classes=cadres,  random_state=seed, n_redundant = redundant, class_sep = classep, flip_y = flip)
    ...
    def generate_variables(cadres, samples, features, classes, informative, seed, redundant, classep, flip):
        """        
        ...
        for cadre in range(cadres):
            seed_c=cadre*seed
            X, y= make_classification(n_samples=samples, n_features=features, n_informative=informative,  n_classes=classes,  random_state=seed_c, n_redundant = redundant, class_sep = classep, flip_y = flip)
